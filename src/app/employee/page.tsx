        ...
        <>
            ...
            <div className='m-10'>
                <div className="flex flex-row items-center justify-center space-x-0 px-20">
                    <div className="w-1/2 h-[300px] flex-row bg-slate-50 bg-center rounded-l-lg">
                        <div className="h-[300px] flex-row bg-slate-50 bg-center rounded-l-lg" style={{ backgroundImage: "url('/images/About.png')" }}>

                        </div>
                    </div>
                    <div className="w-1/2 h-[300px] flex-row bg-slate-50 bg-center rounded-r-lg">
                        <div className="flex items-center justify-center mx-5 my-11">
                            <div className="text-center w-80 flex flex-col gap-y-5">
                                ...
                                <p
                                    className="text-sm text-black1 text-start"
                                    style={{
                                        display: "-webkit-box",
                                ...
                                >
                                    มีประสบการณ์การทำงานเป็นแพทย์ความงาม 10 ปี ดูแลเคสปรับรูปหน้าหลากหลายรูปแบบเป็นเบื้องหลังการออกแบบคอร์สอบรมแพทย์ภายในองค์กรให้กับคลินิกหลายแห่งทั่วประเทศ
                                </p>
                                <p className="text-sm text-black1 ">
                                    095-6789805
                                </p>
                ...
                <div className="flex flex-row items-center justify-center space-x-0 px-20 my-10">
                    ...
                    <div className="w-1/2 h-[300px] flex-row bg-slate-50 bg-center rounded-r-lg">
                        <div className="h-[300px] flex-row bg-slate-50 bg-center rounded-r-lg" style={{ backgroundImage: "url('/images/About.png')" }}>
                        </div>
                    </div>
                </div>
